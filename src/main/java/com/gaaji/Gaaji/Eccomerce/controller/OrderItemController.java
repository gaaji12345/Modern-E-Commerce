...
public class OrderItemController {
    ...
    @PostMapping("/create")
    public ResponseEntity<Responce> placeOrder(@RequestBody OrderRequest orderRequest){
    ...
    public ResponseEntity<Responce> updateOrderItemStatus(@PathVariable Long orderItemId,  @RequestParam String status){
    ...
    @GetMapping("/filter")
    @PreAuthorize("hasAuthority('ADMIN')")
    public ResponseEntity<Responce> filterOrderItems(
