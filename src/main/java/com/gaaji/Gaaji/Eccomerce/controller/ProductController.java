...
public class ProductController {
    ...
    public ResponseEntity<Responce> createProduct(
    ...
    @PutMapping("/update")
    @PreAuthorize("hasAuthority('ADMIN')")
    public ResponseEntity<Responce> updateProduct(
    ...
    @PreAuthorize("hasAuthority('ADMIN')")
    public ResponseEntity<Responce> deleteProduct(@PathVariable Long productId){
    ...
    public ResponseEntity<Responce> getProductById(@PathVariable Long productId){
        return ResponseEntity.ok(productService.getProductById(productId));
    }

    @GetMapping("/get-all")
    public ResponseEntity<Responce> getAllProducts(){
        return ResponseEntity.ok(productService.getAllProducts());
    }


    @GetMapping("/get-by-category-id/{categoryId}")
    public ResponseEntity<Responce> getProductsByCategory(@PathVariable Long categoryId){
        return ResponseEntity.ok(productService.getProductsByCategory(categoryId));
    }

    @GetMapping("/search")
    public ResponseEntity<Responce> searchForProduct(@RequestParam String searchValue){
